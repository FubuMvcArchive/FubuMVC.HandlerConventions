...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.HandlerConventions"
COPYRIGHT = 'Copyright 2012 FubuMVC.HandlerConventions. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.HandlerConventions.sln', :clrversion => CLR_TOOLS_VERSION
